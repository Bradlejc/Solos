...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="key_contacts.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Key Contacts</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3 pt-3">
                ...
                <div class="col-md-6 col-lg-3 last_attorney">
                    <button class="btn btn-primary w-100 h-100 add_attorney_btn">Attorney +</button>
                </div>
            </div>
            ...
            <div class="row g-3 pt-3">
                ...
                <div class="col-md-6 col-lg-3 last_financialadvisor">
                    <button class="btn btn-primary w-100 h-100 add_financialadvisor_btn">Financial Advisor +</button>
                </div>
            </div>
            ...
            <div class="row g-3 pt-3">
                ...
                <div class="col-md-6 col-lg-3 last_insuranceagent">
                    <button class="btn btn-primary w-100 h-100 add_insuranceagent_btn">Insurance Agent +</button>
                </div>
            </div>
