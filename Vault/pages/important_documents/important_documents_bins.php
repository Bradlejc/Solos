...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="mt-3 mb-3">
            <h1 class="h3 text-dark">Important Documents</h1>
        </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <a class="btn btn-link text-secondary text-decoration-none"
                                    href="important_personal_documents.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-dark text-uppercase mb-1">
                                    Business</div>
                                <a class="btn btn-link text-secondary text-decoration-none"
                                    href="important_business_documents.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-dark text-uppercase mb-1">
                                    Medical</div>
                                <a class="btn btn-link text-secondary text-decoration-none"
                                    href="important_medical_documents.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-dark text-uppercase mb-1">
                                    Financial</div>
                                <a class="btn btn-link text-secondary text-decoration-none"
                                    href="important_financial_documents.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
