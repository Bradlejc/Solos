...
<head>
    ...
    <title>Important Business Documents</title>
    ...
    <div class="container-fluid">
        ...
        <form action="pets.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Important Business</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <label for="formFile" class="form-label"><strong>Organizational Docs</strong></label>
