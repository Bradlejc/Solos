...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="hotel.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Hotel</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3 justify-content-center mt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_hotel_btn">Hotel +</button>
                </div>
            </div>
    </div>
