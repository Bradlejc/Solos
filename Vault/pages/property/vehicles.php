...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="vehicles.php" method="POST" id="add_personal_information">
            ...
            <div class="row g-3 justify-content-center mt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_vehicle_btn">Vehicle +</button>
                </div>
            </div>
    </div>
