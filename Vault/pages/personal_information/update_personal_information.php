...
<body>
    ...
    $check_parents_query = mysqli_query($conn, "SELECT parent_name FROM parents WHERE id='$userID'");
    $check_siblings_query = mysqli_query($conn, "SELECT sibling_name FROM siblings WHERE id='$userID'");
    ...
    <div class="container-fluid">
        ...
        <form action="update_personal_information.php" method="POST" id="add_personal_information">
            ...
            <div class="row g-3">
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['legal_name']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="maiden_name" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['maiden_name']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="date" name="dob" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['DOB']; ?>">
                ...
                <div class=" col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="ssn" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['SSN']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="address" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['address']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="passport_number" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['passport_number']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="drivers_license_number" class="form-control shadow-none"
                            id="floatingInput"
                            value="<?php echo $personal_information_user['drivers_license_number']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="po_box_number" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['PO_number']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="church_affiliation" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['church_affiliation']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <select name="military_service" class="form-select w-100 h-100 shadow-none"
                        ...
                        <?php if (!empty($personal_information_user['military_service'])) {
                            echo '<option selected value="' . $personal_information_user["military_service"] . '">' . ucwords($personal_information_user["military_service"]) . '</option>';
                        } else {
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="education" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['education']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="citizenship_information" class="form-control shadow-none"
                            id="floatingInput"
                            value="<?php echo $personal_information_user['citizenship_information']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="spouse_other" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['spouse_other']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="phone_pin_code" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['phone_code']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="email_address" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['email_address']; ?>">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="email_password" class="form-control shadow-none" id="floatingInput"
                            value="<?php echo $personal_information_user['email_password']; ?>">
