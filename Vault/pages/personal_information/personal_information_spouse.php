...
<head>
    ...
    <title>Personal Information | Add Spouse</title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="personal_information_spouse.php" method="POST" id="add_personal_information_spouse">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Spouse Information</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <select name="military_service" class="form-select w-100 h-100 shadow-none" placeholder="Hello">
