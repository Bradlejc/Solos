    ...
    <div class="container-fluid">
        ...
        <form action="airline.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Arrangements</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        ...
                        <label for="floatingInput">Funeral Home</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">How I want my remains disposed</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Cemetery</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Memorial Stone</label>
                    </div>
                </div>
