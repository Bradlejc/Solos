...
<head>
    ...
    <title>Exchanges Bought & Sold</title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="exchanges.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Exchanged Bought & Sold</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3 new_pet">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Assets Owned</label>
                    </div>
                </div>
            ...
            <div class="row g-3 justify-content-center mt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_wallet_btn">Add +</button>
                </div>
            </div>
    </div>
