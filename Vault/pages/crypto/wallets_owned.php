...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="wallets_owned.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Wallets Owned</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3 new_pet">
                <div class="col-md-6 col-lg-6">
                    <div class="form-floating">
                        ...
                        <label for="floatingInput">Wallet Name</label>
                    </div>
                </div>
