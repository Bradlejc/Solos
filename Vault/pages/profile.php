                            ...
                            <div class="col mr-2">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <h6 class="card-subtitle mb-2 text-muted">Member Since:
                                            <?php echo $user['date_created']; ?>
                                        </h6>
                                    </div>
                                    <i
                                        class="fa-solid fa-user fa-2x d-flex align-items-middle my-auto p-3 rounded-circle border border-dark border-5"></i>
                                </div>
                            </div>
                        </div>
                    </div>
