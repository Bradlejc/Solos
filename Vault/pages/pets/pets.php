    ...
    <div class="container-fluid">
        ...
        <form action="pets.php" method="POST" id="add_personal_information">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3 show_healthcondition_item">
                    <div class="input-group h-100">
                        <input type="text" name="healthconditions[]" class="form-control shadow-none"
                            placeholder="Health Condition">
                        <button class="btn btn-primary add_healthcondition_btn">+</button>
                    </div>
                </div>
            ...
            <div class="row g-3 justify-content-center mt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_pet_btn">Pet +</button>
                </div>
            </div>
    </div>
