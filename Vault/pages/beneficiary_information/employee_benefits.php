...
<head>
    ...
    <title>Beneficiary Employee Benefits</title>
    ...
    <div class="container-fluid">
        ...
        <form action="personal_information.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Beneficiary Employee Benefits</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3 new_employeebenefits">
            ...
            <div class="row g-3 justify-content-center mt-3" id="new_l_&_hi">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_employeebenefits_btn">+</button>
                </div>
            </div>
