    ...
    <div class="container-fluid">
        ...
        <form action="airline.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Financial | Debt</h1>
                </div>
                <div class="col-3">
            ...
            <div class="mt-3 mb-3">
                <h1 class="h3 text-dark">Credit Card</h1>
            </div>
            ...
            <div class="mt-3 mb-3">
                <h1 class="h3 text-dark">Mortgage</h1>
            </div>
            ...
            <div class="row g-3 pt-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Lender Name</label>
                    </div>
                </div>
            ...
            <div class="mt-3 mb-3">
                <h1 class="h3 text-dark">Car Loan</h1>
            </div>
            ...
            <div class="mt-3 mb-3">
                <h1 class="h3 text-dark">Student Loans</h1>
            </div>
            ...
            <div class="row g-3 justify-content-center pt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_studentloans_btn">Add +</button>
                </div>
            </div>

            <div class="mt-3 mb-3">
                <h1 class="h3 text-dark">Medical Bills/Other Debt</h1>
            </div>
            ...
            <div class="row g-3 justify-content-center pt-3">
                <div class="col-md-6 col-lg-3 mb-3">
                    <button class="btn btn-primary w-100 add_otherdebt_btn">Add +</button>
                </div>
            </div>
