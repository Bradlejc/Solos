    ...
    <div class="container-fluid">
        ...
        <form action="airline.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Financial | Banking</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <select name="military_service" class="form-select w-100 h-100 shadow-none"
                        ...
                        <option value="army">Checkings</option>
                        <option value="navy">Savings</option>
                    </select>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Mothers Maiden Name</label>
                    </div>
                </div>
            ...
            <div class="row g-3 py-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Safety Deposit Box</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Name of Bank</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Box Number</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Location of Keys</label>
                    </div>
                </div>
