...
<head>
    ...
    <title>Financial | Investments</title>
    ...
    <div class="container-fluid">
        ...
        <form action="airline.php" method="POST" id="add_personal_information">
            <div class="row g-3 py-3">
                <div class="col-9">
                    <h1 class="fw-bold">Financial | Investments</h1>
                </div>
                <div class="col-3">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <select name="military_service" class="form-select w-100 h-100 shadow-none"
                        ...
                        <option value="army">Individual</option>
                        <option value="navy">Joint</option>
                        <option value="navy">Trust</option>
                        <option value="navy">IRA</option>
                        <option value="navy">401K</option>
                        <option value="navy">SEP</option>
                        <option value="navy">Other</option>
                    </select>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        ...
                        <label for="floatingInput">Account Description</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Name of Account</label>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="form-floating">
                        <input type="text" name="full_legal_name" class="form-control shadow-none" id="floatingInput">
                        <label for="floatingInput">Advisor Name</label>
                    </div>
                </div>
            ...
            <div class="row g-3 justify-content-center mt-3">
                <div class="col-md-6 col-lg-3">
                    <button class="btn btn-primary w-100 add_hierloom_btn">Add +</button>
                </div>
            </div>
