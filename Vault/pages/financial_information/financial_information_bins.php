...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="mt-3 mb-3">
            <h1 class="h3 text-dark">Financial Information</h1>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-dark text-uppercase mb-1">
                                    Investments</div>
                                <a class="btn btn-link text-secondary text-decoration-none" href="investments.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
                                <i class="fa-solid fa-coins fa-2x text-secondary"></i>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs fw-bold text-dark text-uppercase mb-1">
                                    Debt</div>
                                <a class="btn btn-link text-secondary text-decoration-none" href="debt.php">
                                    Enter Bin
                                </a>
                            </div>
                            <div class="col-auto">
